...
const GRUPOS = [
  ...
  // frases curtas de divulgação ("Mais um Baratino de Jero!", "Corre que é só hoje")
  G(["mais um", "outro"], true),
  G(["mais uma", "outra"], true),
  G(["não perca", "não deixe passar"], true),
  G(["corre que", "aproveita que"], true),
  G(["só hoje", "somente hoje", "apenas hoje"]),
  G(["vem aí", "está chegando"]),
];
